...
import pandas as pd
from advisor_prediction_contract import (
    build_prediction_contract_context as build_prediction_contract_payload,
    prediction_entry_plan_ref,
    prediction_execution_policy_ref,
...
class TradingAdvisor:
    ...
    def _prediction_to_float(value: object) -> float | None:
        return prediction_to_float(value)
    ...
    def _prediction_risk_label(
        *,
        ...
        return prediction_risk_label(recommendation=recommendation, analysis=analysis)
    ...
    def _prediction_entry_plan_ref(
        *,
        ...
        return prediction_entry_plan_ref(strategy=strategy, recommendation=recommendation, analysis=analysis)
    ...
    def _prediction_execution_policy_ref(
        *,
        ...
        return prediction_execution_policy_ref(
    ...
    def _prediction_vetoes(
        *,
        ...
        return prediction_vetoes(recommendation=recommendation, analysis=analysis)
    ...
    def build_prediction_contract_context(
        ...
        *,
        ...
        return build_prediction_contract_payload(
            strategy=strategy,
            recommendation=recommendation,
            analysis=analysis,
            execution_overlay=execution_overlay,
